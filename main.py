...
parser = argparse.ArgumentParser(description='Improving robustness against stealthy weight bit-flip attacks by output code matching')
...
parser.add_argument('--clustering', '-pc', action='store_true', help='add the piecewise clustering term.')
